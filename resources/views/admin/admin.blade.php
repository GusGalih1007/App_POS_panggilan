...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('AdminLTE-3.0.5/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
...
<body class="hold-transition sidebar-mini">
    ...
    <!-- AdminLTE App -->
    <script src="{{ asset('AdminLTE-3.0.5/dist/js/adminlte.min.js') }}"></script><!-- DataTables -->
